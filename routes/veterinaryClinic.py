...
tag = "veterinary_clinics"

@veterinary_clinics.post("/veterinary_clinics/", response_model=VeterinaryClinicSchemaGet, status_code=status.HTTP_201_CREATED, tags=[tag])
...
@veterinary_clinics.get("/veterinary_clinics/", response_model=list[VeterinaryClinicSchemaGet], status_code=status.HTTP_200_OK, tags=[tag])
